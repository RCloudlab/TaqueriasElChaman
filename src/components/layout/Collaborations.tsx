        ...
        <section className="relative w-full py-20 px-5 bg-white overflow-hidden">
            <div className="relative z-20 max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-4">
                    <a
                        href="mailto:taqueriasaelchaman@gmail.com"
                        className="w-full md:w-auto text-center bg-[#C00F0C] text-white px-12 py-2 rounded-md text-sm hover:bg-red-800 transition-colors"
                    >
                        Contactar
                    </a>
                    <a
                        ...
                        className="w-full md:w-auto text-center border border-[#C00F0C] px-12 py-2 rounded-md text-sm hover:bg-[#C00F0C] hover:text-white transition-colors"
                    >
